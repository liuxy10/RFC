...
class MyoOSLController:
    ...
    def initDefaults(self, body_mass):
        ...
        temp_dict = {}
        temp_dict['e_stance'] = {} # yellow
        temp_dict['e_stance']['gain'] = {}
        temp_dict['e_stance']['threshold'] = {}
        temp_dict['e_stance']['gain']['knee_stiffness'] = 99.372 * (body_mass/50)
        temp_dict['e_stance']['gain']['knee_damping'] = 3.180 
        temp_dict['e_stance']['gain']['knee_target_angle'] = 0.6 # np.deg2rad(5)
        ...
        temp_dict['l_stance'] = {} # coral (red)
        temp_dict['l_stance']['gain'] = {}
        temp_dict['l_stance']['threshold'] = {}
        temp_dict['l_stance']['gain']['knee_stiffness'] = 99.372 * (body_mass/50)
        temp_dict['l_stance']['gain']['knee_damping'] = 1.272 * (body_mass/50)
        temp_dict['l_stance']['gain']['knee_target_angle'] = np.deg2rad(8)
        temp_dict['l_stance']['gain']['ankle_stiffness'] = 79.498 * (body_mass/50)
        ...
        temp_dict['e_swing'] = {} # blue
        temp_dict['e_swing']['gain'] = {}
        temp_dict['e_swing']['threshold'] = {}
        temp_dict['e_swing']['gain']['knee_stiffness'] = 39.749 * (body_mass/50)
        temp_dict['e_swing']['gain']['knee_damping'] = 0.063 * (body_mass/50)
        temp_dict['e_swing']['gain']['knee_target_angle'] = np.deg2rad(5) #np.deg2rad(60)
        ...
        temp_dict['l_swing'] = {} # green
        temp_dict['l_swing']['gain'] = {}
        temp_dict['l_swing']['threshold'] = {}
        temp_dict['l_swing']['gain']['knee_stiffness'] = 15.899 * (body_mass/50)
        temp_dict['l_swing']['gain']['knee_damping'] = 3.816
        temp_dict['l_swing']['gain']['knee_target_angle'] = np.deg2rad(35)
